    ...
    <div className="landing-page">
      ...
      <div className="flex flex-col justify-center items-center min-h-[800px]">
        <h1 className="max-w-[800px] text-6xl font-bold text-center text-shadow-lg">
          Turn Ideas into <span className="text-[#2464c7]">Telegram Bots</span> Instantly with AI
        </h1>
        ...
        <div className="flex flex-row items-center justify-center gap-4 mt-4">
          <InputBar />
          <SignInButton>
            <Button className="px-4 py-2 rounded-md cursor-pointer bg-[#2464c7] text-white ">Get Started</Button>
          </SignInButton>
        </div>
      </div>
    </div>
