...
export const answerSchema = z.object({
  answer: z
    .string()
    .describe(
      `Respond to the user's request by confirming that you will fulfill their request to create a Telegram bot based on their input. Do not ask for more information.`
    ),
  enhancedPrompt: z.string()
    .describe(`Enhance the user's original prompt for creating a Telegram bot by making it clear, specific, focusing on a minimal viable implementation. The enhanced prompt should include:
      ...
      - IMPORTANT:If the user provides data, make sure to include ALL of it, keep it EXACTLY as it was provided.
